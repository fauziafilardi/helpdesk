							...
							<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true" data-pagination="true" data-sort-name="name" data-sort-order="desc">
								<thead>
									<tr>
										...
										<th data-field="sub_kategori" data-sortable="true">Nama Sub Kategori</th>
								...
								<tbody>
									...
									foreach ($datamyassignment as $row) : $no++; ?>
										<tr>
											...
											<td data-field="sub_kategori"><?php echo $row->nama_sub_kategori; ?></td>
											<td data-field="progress"><?php echo $row->progress; ?></td>
											<td data-field="aksi">
